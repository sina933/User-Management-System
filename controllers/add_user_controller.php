...
if($_SERVER["REQUEST_METHOD"]=='POST'){
    ...
    try{
        ...
        $sql="insert into users (FirstName,LastName,email,password,role) value(?,?,?,?,?)";
        ...
        //   echo "کاربر با  موفقیت اضافه شد";
            ...
            echo "خطا در هنگام اضافه کردن کاربر";
        }

    } catch(PDOException $e){

        echo "حطا". $e->getMessage();
    }
}
...
<div id="card" class="animated fadeIn">
    ...
    <div id="lower-side">
        ...
        <a href="../models/users.php" id="contBtn">Continue</a>
    </div>
</div>
<br>
